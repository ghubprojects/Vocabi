...
namespace Vocabi.Infrastructure.Migrations
{
    ...
    [Migration("20250918174838_AddTimestampColumnsForFlashcardStatus")]
    partial class AddTimestampColumnsForFlashcardStatus
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vocabi.Domain.Aggregates.Pronunciations.Pronunciation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.OwnsOne("Vocabi.Domain.Aggregates.Vocabularies.VocabularyFlashcard", "Flashcard", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("ExportedAt")
                                .HasColumnType("timestamp with time zone");

                            b1.Property<DateTime?>("LastTriedAt")
                                .HasColumnType("timestamp with time zone");
